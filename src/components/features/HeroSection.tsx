      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-20 pt-32 md:pt-40 z-10 order-2 md:order-1">
        <div className="max-w-xl space-y-6">
          ...
          >
            ...
            <Link 
              href="/shop" 
              className="group relative px-8 py-4 bg-[#02303A] text-[#F9F7F2] rounded-full font-semibold overflow-hidden flex items-center"
            >
            ...
            {/* LINK 2: Visit Us (Updated to point to /locations) */}
            <Link 
              href="/locations"
              className="px-8 py-4 border-2 border-[#02303A] text-[#02303A] rounded-full font-semibold hover:bg-[#02303A]/5 transition-colors flex items-center gap-2"
            >
              <MapPin size={18} />
              Visit Us
            </Link>
